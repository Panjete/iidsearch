...
from readers_10 import getMapping, getVals, pointers_to_post
from process_query10 import processQ
...
def q10(queryfile, outputfile,indexfile, dictfile):
    ...
    for i in range(len(query_nums)):
        ...
        top_100 = processQ(query_titles[i] + query_desc[i], indexfile, pointers, numdocs, mapToDocs)
